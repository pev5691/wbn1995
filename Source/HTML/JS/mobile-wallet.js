...
var DiagramArr = [{name:"MAX:ALL_NODES", text:"All nodes count", value:0, red:"#1d506b", MouseText:" nodes", CountNameX:10},
    {name:"MAX:HASH_RATE_B", text:"HashRate, WBN hash/s", value:0, red:"#286b16", MathPow:2, MathDiv:1024 * 1024 * 1024 * 1024,
...
var LangMap = {};
LangMap["ENG"] = {};
LangMap["RUS"] = {"Insert your private key or generate a new key below...":"Заполни данные твоего приватного ключа или сгенерируй новый...", "2020 WellBeing Network":"2020 криптосеть Благополучие", "WBN WALLET":"WBN КОШЕЛЕК", "Generate key":"Сгенерировать ключ", "OK":"OK", "Cancel":"Отмена", "Edit":"Редактирование",
    ...
    "YOUR ASSETS":"ТВОИ АКТИВЫ", "MANAGING PAYMENTS":"УПРАВЛЕНИЕ ПЛАТЕЖАМИ", "USEFUL APPLICATION":"ПОЛЕЗНЫЕ ПРИЛОЖЕНИЯ", "OVERVIEW BLOCKCHAIN":"ОБЗОР БЛОКЧЕЙНА", "ATTENTION: Before using the wallet, save the private key.":"ВНИМАНИЕ: Перед использованием кошелька сохраните приватный ключ",
    ...
    "Welcome to the well-being management system":"Вас приветствует система управления благополучием", "Edit your wallet":"Редактирование вашего кошелька", "Key settings":"Задание ключей",
    ...
    "Sending Tx":"Отправка транзакции", "Wallet ver:":"Версия:", "Guide to managing your personal account in the well-Being system":"Руководство по управлению личным кабинетом системы Благополучие", "==HELP-LINK==":"https://docs.google.com/document/d/1xKRV_nlKGN37z_fdT35Kv3XSMOy_IvMat_swMC0AZZY/edit?usp=sharing",
};
LangMap["简体中文"] = {"Insert your private key or generate a new key below...":"Заполни данные твоего приватного ключа или сгенерируй новый...", "2020 WellBeing Network":"2020 криптосеть Благополучие", "WBN WALLET":"WBN 钱包", "Generate key":"生成私钥", "OK":"OK", "Cancel":"取消", "Edit":"编辑", "Save key":"保存私钥",
    ...
    "More info":"详情", "Public key":"公钥", "Guide to managing your personal account in the well-Being system":"WBN钱包创建指南", "==HELP-LINK==":"https://docs.google.com/document/d/1xKRV_nlKGN37z_fdT35Kv3XSMOy_IvMat_swMC0AZZY/edit?usp=sharing",
};
LangMap["한글"] = {"Insert your private key or generate a new key below...":"Заполни данные твоего приватного ключа или сгенерируй новый...", "2020 WellBeing Network":"2020 криптосеть Благополучие", "WBN WALLET":"WBN 지갑", "Generate key":"개인 키 생성", "OK":"OK", "Cancel":"취소", "Edit":"편집", "Save key":"개인 키 저장",
    ...
    "Public name":"이름", "Currency":"화폐", "Pay to:":"지불:", "Amount:":"수량:", "Description:":"묘사:", "Welcome to the well-being management system":"WBN 지갑을 환영합니다",
