...
LangMap["RUS"] = {"WBN WALLET":"WBN КОШЕЛЕК", "Generate key":"Сгенерировать ключ", "OK":"OK", "Cancel":"Отмена", "Edit":"Редактирование",
    ...
    "YOUR ASSETS":"ТВОИ АКТИВЫ", "PAYMENTS":"ПЛАТЕЖИ", "USEFUL APPLICATION":"ПОЛЕЗНЫЕ ПРИЛОЖЕНИЯ", "OVERVIEW OF BLOCKCHAIN":"ОБЗОР БЛОКЧЕЙНА", "ATTENTION: Before using the wallet, save the private key.":"ВНИМАНИЕ: Перед использованием кошелька сохраните приватный ключ",
