...
class AccountApp extends require("./dapp")
{
    ...
    Start(bClean)
    {
        ...
        this.DBStateWriteInner({Num:12, PubKey:GetArrFromHex(ARR_PUB_KEY[4]), Value:{BlockNum:1, SumCOIN:0}, Name:"Fond Bounties First"})
        this.DBStateWriteInner({Num:13, PubKey:GetArrFromHex(ARR_PUB_KEY[5]), Value:{BlockNum:1, SumCOIN:0}, Name:"Fond Bounties Second"})
        this.DBStateWriteInner({Num:14, PubKey:GetArrFromHex(ARR_PUB_KEY[6]), Value:{BlockNum:1, SumCOIN:0}, Name:"Fond Bounties Thrid"})
        this.DBStateWriteInner({Num:15, PubKey:GetArrFromHex(ARR_PUB_KEY[7]), Value:{BlockNum:1, SumCOIN:0}, Name:"Fond Bounties Four"})
