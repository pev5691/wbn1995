# WellBeing Network (WBN) platform ![Публичная криптоплатформа нового поколения](https://github.com/pev5691/wbn1995/blob/wellbeing/Source/HTML/PIC/Tera_logo.svg)
